 ...
 * @Package: me.owen.processor
 * @ClassName: RequireLoginProcessor
 * @Description: java类作用描述
 * @Author: Owen
 * @CreateDate: 2021/10/11 0011 下午 8:29
 * @UpdateUser: 更新者
 * @UpdateDate: 2021/10/11 0011 下午 8:29
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
...
public class RequireLoginProcessor extends AbstractProcessor {
    ...
    private String pkName = "me.owen.login.apt";
